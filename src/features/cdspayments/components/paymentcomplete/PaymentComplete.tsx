        ...
        <PaymentProviderCard backgroundColor="bg-[#42B39640]">
          <div className="space-y-4">
            <div className="flex flex-col items-center space-y-2 py-4">
              ...
              <h3 className="text-2xl text-center leading-[125%]">Pagamento confermato!</h3>
              <p className="text-center text-secondary">Il tuo pagamento è stato completato con successo.</p>
            </div>

            {orderDetails && (
              <ul className="space-y-3 border-t border-[#42B396]/30 pt-4">
                <li className="flex flex-col gap-1">
                  <span className="text-secondary text-sm">N. Ordine</span>
                  <span className="text-tertiary font-medium">{orderDetails.order_id}</span>
                </li>
                <li className="flex flex-col gap-1">
                  <span className="text-secondary text-sm">Descrizione</span>
                  <span className="text-tertiary">{orderDetails.description}</span>
                </li>
                <li className="flex flex-col gap-1">
                  <span className="text-secondary text-sm">Venditore</span>
                  <span className="text-tertiary">{orderDetails.vendor_name}</span>
                </li>
              </ul>
            )}
            ...
            {orderDetails?.return_url && (
              <a
                ...
                className="artpay-button-style bg-primary hover:bg-primary-hover text-white mt-4 block text-center">
