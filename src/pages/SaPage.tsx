    ...
    <DefaultLayout>
      <section className={"mt-28  h-full px-8 lg:mx-auto lg:max-w-5xl lg:px-0 lg:mt-36"}>
        ...
        <article className={"leading-[125%] pb-24 "}>
          ...
          <p className={"text-secondary text-sm mt-10 mb-16 lg:px-40"}>8 giugno 2025 - 2 minuti di lettura</p>
          <main>
            <img
              src={cover_sa}
              width={600}
            ...
            />
            <h2 className={"text-balance text-3xl mt-16 mb-10 lg:px-40"}>Perché scegliere artpay?</h2>
